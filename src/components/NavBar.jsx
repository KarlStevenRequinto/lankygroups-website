                ...
                <div className="flex justify-between items-center text-base gap-8">
                    ...
                    <ul className="md:flex space-x-12 hidden">
                        {navItems.map(({ link, path }) => (
                            <Link key={path} to={path} spy={true} smooth={true} offset={-100} className="block text-base text-gray900 hover:text-brandPrimary first:font-medium">
                                {link}
                            </Link>
                        ))}
                    </ul>
                    ...
                    <div className="space-x-12 hidden lg:flex items-center">
                        <a href="/" className=" hidden lg:flex items-center hover:text-gray-900">Login</a>
                    ...
                    <div className="md:hidden">
                        <button className="focus:outline-none text-neutralDGrey focus:text-gray-500" onClick={toggleMenu}>
